...
public class MON_SkeletonLord extends Entity {
    ...
    public void getImage(){
        ...
        int i = 5;
        if(inRage == false){
            up1 = setup("/monster/skeletonlord_up_1", gp.tileSize*i,gp.tileSize*i); //240 * 240
        ...
        if(inRage == true){
            up1 = setup("/monster/skeletonlord_phase2_up_1", gp.tileSize*i,gp.tileSize*i); //240 * 240
    ...
    public void setAction(){
        ...
        if(inRage == false && life < maxLife/3){
            inRage = true;
            getImage();
            getAttackImage();
            defaultSpeed++;
